...
const CarIcon = () => (
  <span className='block max-w-[55px] min-w-[40px] max-h-[55px] min-h-[40px] h-[55px] mt-0 mb-[0px] mx-auto'>
    <svg 
                    className='group-hover:fill-red-500 fill-[#A6A6A6] group-focus:fill-red-500' 
                    version="1.0" xmlns="http://www.w3.org/2000/svg"
                    width="70" height="70" viewBox="0 0 1280.000000 640.000000"
                    preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,640.000000) scale(0.100000,-0.100000)"
                    stroke="none">
...
const PersonalCar = () => {
  ...
  return (
    <div className='mx-[2px] my-0 group'>
      <div className='h-[89px] text-[#454545] w-full cursor-pointer group ml-[12px]' onClick={handleDropdownClick}>
        <CarIcon />
      ...
      {showDropdown && (
        <div className='absolute left-0 top-[100%] bg-[#f2f2f2] w-full p-[30px] leading-6 text-left shadow-inner box-border'>
          <button
          ...
          <p className='text-[#4d4d4d] text-[2.5rem] block pt-0 pr-0 pb-[20px] pl-[17px]'>
            Для личного авто
          </p>
         <div className='p-0 mr-0 grid grid-cols-4 grid-rows-1 box-border '> 
          <ul className='p-0 flex flex-col'>
            <li className='basis-1/3'>
              <a className='py-3 pl-5 pr-0'>
                <div className='flex items-center ml-6 align-center hover:underline hover:cursor-pointer'>
                  <svg 
